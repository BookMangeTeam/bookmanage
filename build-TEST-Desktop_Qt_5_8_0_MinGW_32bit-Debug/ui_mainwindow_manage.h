...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow_Manage)
    {
        ...
        amount->setText(QApplication::translate("MainWindow_Manage", "\346\225\260\351\207\217", Q_NULLPTR));
        status->setText(QApplication::translate("MainWindow_Manage", "\347\212\266\346\200\201", Q_NULLPTR));
        add_status->clear();
        add_status->insertItems(0, QStringList()
         << QApplication::translate("MainWindow_Manage", "    \345\217\257\345\200\237\351\230\205", Q_NULLPTR)
         << QApplication::translate("MainWindow_Manage", "   \344\270\215\345\217\257\345\200\237\351\230\205", Q_NULLPTR)
        );
