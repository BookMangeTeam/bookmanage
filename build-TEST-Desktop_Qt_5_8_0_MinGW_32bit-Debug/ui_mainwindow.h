...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        name->setGeometry(QRect(140, 280, 521, 141));
        QFont font;
        ...
        label->setGeometry(QRect(290, 170, 231, 91));
        QFont font1;
        ...
        bookNameBorrow_search->setFont(font2);
        ...
        authorBorrow_search->setFont(font2);
        ...
        isbnBorrow_search->setFont(font2);
        ...
        bookNumberBorrow_search->setFont(font2);
