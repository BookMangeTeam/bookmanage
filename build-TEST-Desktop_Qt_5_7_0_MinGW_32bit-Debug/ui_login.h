...
public:
    ...
    void setupUi(QWidget *Login)
    {
        ...
        loginBackgroundFrame->setStyleSheet(QStringLiteral("background:#fff"));
        ...
        title->setGeometry(QRect(80, 70, 271, 61));
        QFont font;
        ...
        user_nameInput->setGeometry(QRect(90, 220, 241, 41));
        QFont font2;
        ...
        passwordInput->setGeometry(QRect(90, 320, 241, 41));
        ...
        loginButton->setGeometry(QRect(90, 430, 101, 41));
        ...
        registerButton->setGeometry(QRect(230, 430, 101, 41));
